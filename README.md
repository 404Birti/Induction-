...
**Japji Sahib**  
Path was ongoing before 8:30 AM.
...
- Education loan reforms — 0% interest options now available, with limits up to ₹10 lakhs.
- A roadmap to wealth-building through habit-based investing.

> It was the first time I felt like maybe money and maths could actually be interesting — and doable.
...
> Made me rethink food as more than just taste or health — but also as science and culture.
...
- Learned how to submit induction projects via GitHub.
...
- Connected 206 bones to symbolic mythology.
- Called two students “God and His wife” 😭 (crowd-favorite moment).
- Spray bottle ignition experiment — launched on stage.
- Lit a bulb using his body.
- Wrote “Bhagwan” on the board and said:  
  > “I told you I’d make you meet God.”

> He was electric. Left with more questions, but also this weird clarity. Like curiosity could be holy too.

---

**Universal Human Values & Wellness – Priya Darshani Ma’am**

> A calm pause — reflecting on life beyond academics.

- Differentiated physical needs vs. facilities.
- Discussed understanding, relationships, and emotional balance.
- Emphasized: “Happiness is a state of mind — not a destination.”

> Bit dry, but necessary. Like eating salad when you’d rather have fries.

---

**Doubt-Clearing – HOD, Applied Sciences**

- Took open questions — even asked a few herself to ease us in.
- Cleared confusion around curriculum, tools, clubs, and expectations.
...
**Example – Algorithm**  
> Start → Input `x`, `y` → Sum = `x + y` → Output sum → End
...
- `using namespace std;` → No need for `std::` before `cout`  
...
- Can end with numbers, not start

---

**English Class – Introductions**

Each student shared: name, school, hobbies, strengths, and personal highlights.

> Felt like a soft launch — everyone’s story packed into 2 minutes. Surprisingly humanizing.

---

## DAY FIVE – Getting on Track

**BEEE (Basics of Electrical & Electronics Engineering)**  
Intro session. No circuits — just a syllabus walk-through.

> Introductions again — this time: name, hobby, and board marks.  
> Less pressure, faster pace.

**Chemistry Orientation**  
Internal/external marks, paper structure, and stream division explained.

**Break (12:30–2:00 PM)**  
Explored the sports complex. No badminton, but discovered billiards — quiet, smooth, weirdly satisfying.

**ID Card Photos**  
Quick. Smooth. It’s done.

> Not an intense day academically, but it had rhythm.  
> Slowly settling in.

---

## DAY SIX – Orientation & CML

**Chemistry + Math**  
Syllabus and exam overview. Mid-sems in Sept & Oct (24 marks). Finals in Nov.

**S. Gurcharan Singh – CML**  
Introduced the Center for Multifaceted Learning: training + content creation for school students (grades 6–12, outside India).  
Recruitment via form + interview. Shared info about **NPTEL Batch 29** and how we’re part of the local chapter.

> Password of the day: `1512` 😂

> A slower day but added structure.  
> Less pressure, more clarity.

---

## DAY SEVEN – Clubs, Content & Campus Roles  
> One week in. The campus maze is starting to look like a map.

### Harpreet Ma’am  
Spoke about punctuality — perhaps a bit firmly 😅 — and encouraged students to introduce themselves briefly.

### Dean Student Welfare  
Talked about scholarships, student support, and opportunities to participate in college life.  
We were encouraged to join creative teams covering events, reels, and college media. Clubs like the **English Club** and **Mathamagic** were highlighted.

### Digital Marketing Club (DMC)  
The DMC session was led by sir, who spoke about his journey growing GNDEC’s digital presence.  
He introduced a 16-week digital marketing course he had completed — and offered to waive the fee for any student who completes it too.

> It wasn’t just about followers — it was about turning content into opportunity.

> An energizing, well-paced session. Made digital marketing feel like something worth diving into.

After the break, we had a **BEEE lecture** covering basic concepts, followed by a **P2P session** that deepened our understanding of C++.

> The induction isn’t over — and maybe the best parts aren’t either.  Encouragement and college vision.
- Dean Student Welfare – Dr Paramjit Singh
- Guest of Honor – Er. Ravinder Garg and Er. Rakesh Kumar  
  Shared college journey and values.
